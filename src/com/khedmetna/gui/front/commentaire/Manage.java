...
import com.khedmetna.gui.front.commentaire.DisplayAll;
...
public class Manage extends Form {
    ...
    public Manage(Form previous) {
        super(com.khedmetna.gui.front.commentaire.DisplayAll.currentCommentaire == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentCommentaire = DisplayAll.currentCommentaire;
    ...
    private void showBackAndRefresh() {
        ((com.khedmetna.gui.front.commentaire.DisplayAll) previous).refresh();
        previous.showBack();
    }
