...
public class Manage extends Form {
    ...
    public Manage(Form previous) {
        super(com.khedmetna.gui.front.reclamation.DisplayAll.currentReclamation == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentReclamation = com.khedmetna.gui.front.reclamation.DisplayAll.currentReclamation;
